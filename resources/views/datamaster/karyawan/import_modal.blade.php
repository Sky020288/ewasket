                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>kode_kantor</td>
                                    <td>Wajib diisi, harus sesuai dengan kode kantor yang ada</td>
                                </tr>
                                <tr>
                                    <td>kode_satker</td>
                                    <td>Wajib diisi, harus sesuai dengan kode satker yang ada</td>
                                </tr>
                                <tr>
                                    <td>kode_jabatan</td>
                                ...
                                <tr>
                                    <td>status_personel</td>
                                    <td>Wajib diisi</td>
                                </tr>
                                <tr>
                                    <td>status_aktif_personel</td>
