...
@section('content')
@section('navigasi')
    <span class="text-muted">Personel/</span> Detail
@endsection
<div class="row">
    <div class="col-12">
        <div class="card mb-4">
...
<div class="row">
    <div class="col-xl-3 col-lg-5 col-md-5">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <small class="card-text text-uppercase">Data Personel</small>
                <ul class="list-unstyled mb-4 mt-3">
                    <li class="d-flex align-items-center mb-3">
                        <i class="ti ti-barcode text-heading"></i><span class="fw-medium mx-2 text-heading">NRP:</span>
                    ...
                    <li class="d-flex align-items-center mb-3">
                        <i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 text-heading">
                            Nama Personel:</span> <span>{{ textCamelCase($karyawan->nama_karyawan) }}</span>
                    </li>
                    <li class="d-flex align-items-center mb-3">
